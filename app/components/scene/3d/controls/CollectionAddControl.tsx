...
interface CollectionAddControlProps {
  onBookCreate: (imageUrl: string, thickness: number, aspectRatio: number, title: string) => void
}

export default function CollectionAddControl({ onBookCreate }: CollectionAddControlProps) {
  ...
  return (
    <div className="bg-gray-200 p-4 rounded-none shadow-inner w-full aspect-square">
